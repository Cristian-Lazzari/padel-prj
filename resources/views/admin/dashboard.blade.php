...
<div class="page_nav">
    ...
    <div class="mydash">
        ...
        <form class="setting" action="{{ route('admin.settings.update')}}" method="POST" enctype="multipart/form-data">
            <h2>
            ...
            <div class="top-set">
                ...
                <div class="set">
                    ...
                    <div class="radio-inputs">
                        <label class="radio">
                            <input type="radio" name="tavoli_status"  @if($settings['Servizio di Prenotazione Online']['status'] == 0) checked  @endif value="0" >
                            <span class="name">Off</span>
                        </label>
                        <label class="radio">
                            <input type="radio" name="tavoli_status"  @if($settings['Servizio di Prenotazione Online']['status'] == 1) checked  @endif value="1" >
                            <span class="name">Chiamate</span>
                        </label>

                        <label class="radio">
                            <input type="radio" name="tavoli_status"  @if($settings['Servizio di Prenotazione Online']['status'] == 2) checked  @endif value="2" >
